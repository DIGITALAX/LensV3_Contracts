...
contract CoinOpAction is BasePostAction {
    ...
    function _configure(
        ...
        emit CoinOpInitialized(_designer, _collectionId, postId);
    }
    ...
    function _execute(
        ...
        bytes memory _data = _getParamValue(params, "lens.param.buyCoinop");
        (
        ...
        emit CoinOpPurchased(_collectionIds, _buyer, postId, _total);
    }
