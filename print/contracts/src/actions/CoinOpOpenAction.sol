...
contract CoinOpOpenAction is IPostAction {
    ...
    function execute(
        ...
        bytes memory _data = _getParamValue(params, "buyCoinop");
        (
    ...
    function _transferTokens(
        ...
        if (_fulfillerAmount > 0) {
            IERC20(chosenCurrency).transferFrom(
                buyer,
                _fulfiller,
                _fulfillerAmount
            );
