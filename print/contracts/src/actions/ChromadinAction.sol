...
contract ChromadinAction is BasePostAction {
    ...
    function _configure(
        ...
        emit ChromadinInitialized(_designer, _collectionId, postId);
    }
    ...
    function _execute(
        ...
        bytes memory _data = _getParamValue(params, "lens.param.buyChromadin");
        (
        ...
        emit ChromadinPurchased(_collectionIds, _buyer, postId, _total);
    }
