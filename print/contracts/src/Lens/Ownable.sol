...
abstract contract Ownable is IOwnable {
    event Lens_Ownable_OwnershipTransferred(
    ...
    bytes32 constant STORAGE__OWNABLE =
        0x29cf0539cdb8487ad7dbc33f1a5f82174ca0f44de05580c9bd8cfe649fa8c9fe;

    function $ownableStorage()
        private
        pure
        returns (OwnableStorage storage _storage)
    {
        assembly {
    ...
    modifier onlyOwner() {
        require(
            msg.sender == $ownableStorage().owner,
