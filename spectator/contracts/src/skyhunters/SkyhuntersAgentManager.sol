...
contract SkyhuntersAgentManager {
    ...
    function createAgent(
        ...
        if (accessControls.isAdmin(msg.sender)) {
            _agents[_agentCounter].skyhunter = skyhunter;
            _agents[_agentCounter].studio = studio;
        }
    ...
    function getAgentSkyhunter(uint256 agentId) public view returns (bool) {
        return _agents[agentId].skyhunter;
    }

    function getAgentStudio(uint256 agentId) public view returns (bool) {
        return _agents[agentId].studio;
    }
